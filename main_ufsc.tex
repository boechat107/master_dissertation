...
\textoResumo {
Apresentam-se neste trabalho o desenvolvimento e a implementação de
um sistema de monitoramento e validação de sensores de poços de petróleo,
utilizando técnicas de aprendizado de máquina e modelos empíricos baseados
em histórico de dados
