...
\usepackage{flafter}
\usepackage{textcomp}
%% inhibit latex to float figures/tables across section boundary
...
\titulo{Algoritmos para a Detecção de \textit{Drifting} em Sensores de Fundo de Poço}
...
\departamento{Programa de Pós-Graduação em Engenharia de Automação e Sistemas}
...
% 
\agradecimento{
Ao meu orientador prof. Ubirajara F. Moreno, pela troca de ideias, direcionamento do
trabalho e por toda cordialidade.
\vspace{.5cm}

Ao grupo de trabalho do projeto de pesquisa com o Cenpes/Petrobras, pelo importante
compartilhamento de conhecimentos.
\vspace{.5cm}

Ao Cenpes/Petrobras, pelo suporte financeiro e fornecimento de informações cruciais para o
desenvolvimento do trabalho.
\vspace{.5cm}

Aos grandes amigos que fiz durante esta jornada.
}
...
diferentes conjuntos de dados: um conjunto de dados gerado a partir da simulação do modelo
...
desempenho, manutenção baseada em condição, monitoramento de poços de petróleo.}
...
\keywords {sensor validation, drift, regressive models, performance monitoring, condition
based maintenance, oil well monitoring.}
