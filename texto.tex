...
% TODO:
% -> Explicitar diferença entre predição e estimação
...
\subsection{Detecção de Anomalias/Drift}
\label{sec:deteccao_drift}

SPRT, detecção pela incerteza.
...
empíricos de predição e o módulo estatístico de decisão. Palavras: predictive learning.
