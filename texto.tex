...
%         \midrule
%         0.05 & 1 & 0.5 & 50 & 0.296 \\
%         \rowcolor{gray}0.06 & 1 & 1 & 30 & 0.365 \\
%         0.07 & 0.5 & 1 & 27 & 0.473 \\
%         0.08 & 0.5 & 1 & 24 & 0.581 \\
%         \bottomrule
%     \end{tabular}
...
%         0.03 & 128 & 4 & 122 & 0.19 \\
%         0.04 & 512 & 8 & 73 & 0.26\\
%         \rowcolor{gray} 0.06 & 0.125 & 0.5 & 33 & 0.42\\
%         0.08 & 1 & 1 & 25 & 0.66 \\
%         0.1 & 256 & 2 & 20 & 0.93\\
...
%         0.1 & 32 & 2 & 480 & 4.52 \\
%         1.8 & 16 0.5 & 44 & 4.78 \\
%         \rowcolor{gray}0.2 & 64 & 0.5 & 24 & 4.84 \\
%         0.5 & 16 & 1 & 2 & 29.91 \\
%         \bottomrule
%     \end{tabular}
% \end{table}
...
%         \rowcolor{gray} 0.22 & 1024 & 1 & 15 & 4.92 \\
...
%         \midrule
%         0.006 & 64 & $2^{-19}$ & 202 & 1.2381 \\
%         0.007 & 32 & $2^{-16}$ & 54 & 1.0092 \\
%         0.008 & 128 & $2^{-17}$ & 26 & 1.0616 \\
%         0.009 & 128 & $2^{-16}$ & 14 & 1.0356 \\
%         \rowcolor{gray}0.01 & 16 & $2^{-10}$ & 4 & 1.0092 \\
%         0.011 & 128 & $2^{-16}$ & 8 & 1.6152 \\
%         \bottomrule
%     \end{tabular}
% \end{table}
...
%         \rowcolor{gray} 0.009 & 0.125 & 32 & 15 & 1.054 \\
...
%         \midrule
%         0.1 & 8 & 4 & 210 & 3.19 \\
%         \rowcolor{gray}0.15 & 16 & 1 & 38 & 3.27 \\
%         0.2 & 256 & 0.0625 & 12 & 3.96 \\
%         \bottomrule
%     \end{tabular}
% \end{table}
...
%         \midrule
%         0.1 & 8 & 32 & 220 & 3.23 \\
%         \rowcolor{gray} 0.15 & 512 & 0.5 & 31 & 3.31 \\
...
Nota-se que as predições estão próximas dos valores originados pela simulação, exceto por
uma maior variância nas predições da variável PT$_f$.
...
Em comparação ao modelo AAKR, as predições do modelo SVM apresentaram maior MSE, ou seja,
menor acurácia nas predições, exceto para a variável PT$_m$.
...
modelo SVM para o conjunto de dados de validação gerados por simulação.}
    \begin{tabular}{ccccc}
        \toprule
        & PT$_f$ & PT$_t$ & PT$_m$ & PT$_g$ \\
        MSE & $0.749 \times 10^{-3}$ & $5.43 \times 10^{-3}$ & $3.996 \times 10^{-3}$ &
        $5.621 \times 10^{-3}$ \\
        \midrule
