...
indicações de mudanças nas propriedades estatísticas dos reísduos apresentadas pela camada
...
Na ocorrência de novas amostras com valores maiores que $r_{max,p}$ ou menore
...
Modelos com alto $n_m$ tendem a gerar melhores predições, entretando, o
...
Neste trabalho a seleção dos vetores de mémoria foi realizada pela combinação dos dois
métodos anteriores.
