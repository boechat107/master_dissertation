...
dependente $y \in \Re$ a partir de $n_m$ observações independentes e identicamente
distribuídas.
...
Na Figura \ref{fig:sim_pred_drift4} são apresentadas as predições dos três sistemas na
...
\begin{figure}[bt]
    ...
    (diferentes das linhas verdes apenas na ocorrência de falhas).}
    \label{fig:sim_pred_drift4}
\end{figure}

\begin{table}[bt]
    \centering
    \caption{\label{tab:sim_sprt_conf}}
    \begin{tabular}{lcccc}
        \toprule
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=.4\textwidth]{figuras/sim_svm_resid_d4.eps}
    \includegraphics[width=.4\textwidth]{figuras/sim_svm_sprt_d4.eps}
    \caption{}
