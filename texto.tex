...
A etapa de monitoramento da condição, como o próprio nome sugere, visa monitorar a
condição de funcionamento dos sensores, detectando a ocorrência de eventos e mudanças de
estado.
As indicações das ocorrências de falhas e anomalias
