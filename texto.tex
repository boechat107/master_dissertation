...
\subsection{Construção dos Modelos e Otimização de Parâmetros --- Dados de Simulação}

\subsubsection{AAKR-SPRT}

%TODO:reescrever.
O resultado do processo de otimização dos parâmetros do modelo AAKR é apresentado na
Fig.<++>. Nota-se que modelos com menor MSE apresentam maior equilíbrio entre acurácia e
