...
% \begin{frame}{Sensor Drifts}
%     \begin{itemize}
%         \item Slow rate of change in a signal's correct value
%         \item ``Measurements from an unstable or excessively \alert{drifting} gauge might
%             prove more \alert{troublesome} to an oilfield operator than outright failure
%             of the gauge.''
%     \end{itemize}
%     \begin{figure}[!htb]
%         \centering
%         \includegraphics[width=\textwidth]{figures/drift.eps}
%     \end{figure}
% \end{frame}
% 
% 
% %% Our objective is the 
% \begin{frame}{Performance Assessment of Sensors}
%     \begin{itemize}
%         \item Traditional approach
%             \begin{itemize}
%                 \item periodic manual calibration
%                 \item or\ldots~the sensor's readings are just ignored
%             \end{itemize}
%             \vspace{.8cm}
%         \item Condition based maintenance
%             \begin{itemize}
%                 \item less invasive
%                 \item physical recalibrations are performed only when their performance is
%                     degraded
%             \end{itemize}
%         \item Hardware redundancy
%         \item Analytical redundancy
%             \begin{itemize}
%                 \item models based on physical equations
%                 \item \alert{data-driven models}
%             \end{itemize}
%     \end{itemize}
% \end{frame}
% 
% 
% \begin{frame}{Data-driven Models Approach}
%     \begin{figure}[!htb]
%         \centering
%         \includegraphics[width=\textwidth]{figures/data_driven.eps}
%     \end{figure}
% \end{frame}
% 
